    ...
    <div class="popular container">
        ...
        <?php foreach ($card_list as $key => $val): ?>
            <article class="popular__post post <?=$val['type'];?>">
                ...
                <header class="post__header"> <h2><?=$val['title'];?></h2></header>

                <div class="post__main"> <!--здесь содержимое карточки-->
            
                    <?php if ($val['type']=='post-quote'):  ?> <!--содержимое для поста-цитаты-->
                    ...
                    <?php elseif ($val['type']=='post-link'): ?><!--содержимое для поста-ссылки-->
                    ...
                    <?php elseif ($val['type'] === 'post-photo'): ?> <!--содержимое для поста-фото-->
                    
                    <div class="post-photo__image-wrapper">
                        <img src="img/<?=$val['content']; ?>" alt="Фото от пользователя" width="360" height="240">
                    </div>

                    <?php elseif ($val['type'] === 'post-video'): ?> <!--содержимое для поста-видео-->
                    ...
                    <?php elseif ($val['type'] === 'post-text'): ?> <!--содержимое для поста-текста-->
                        <p><?=$val['content'];?></p>
